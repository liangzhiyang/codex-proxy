export const translations = {
  en: {
    ...
    generalSettingsProxyUrlHint: "SOCKS5/HTTP proxy for upstream. Leave empty to use the system proxy, then direct if none exists.",
  ...
  zh: {
    ...
    generalSettingsProxyUrlHint: "上游代理地址，留空则先用系统代理；没有系统代理时直连。",
